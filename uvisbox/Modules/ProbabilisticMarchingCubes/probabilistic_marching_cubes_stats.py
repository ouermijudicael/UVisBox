...
def probabilistic_marching_cubes_summary_statistics(ensemble_images, isovalue):
    """
    ...
    ensemble_images : np.ndarray
        4D array of shape ``(n_z, n_y, n_x, n_ensemble)`` representing the
        scalar field with ensemble members.
    isovalue : float
    ...
    dict
        ...
        ``(n_z - 1, n_y - 1, n_x - 1)`` with values from 0 to 1.
    """

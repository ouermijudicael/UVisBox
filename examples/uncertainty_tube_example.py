...
.. code-block:: python
    ...
    # trajectories are generated in [n_steps, n_seeds, n_samples, n_dimss]
...
Use eigen values to create texture coordinates for coloring the tubes

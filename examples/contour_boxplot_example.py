...
Define a function to create an ensemble of 2D scalar fields with Gaussian blobs in the center.
...
Visualize the ensemble contours using spaghetti plots and contour boxplots
...
ensemble = create_ensemble_scalarfield(image_res=64, n_ensembles=50, sigma_min=20, sigma_max=100) # create synthetic ensemble of gaussians

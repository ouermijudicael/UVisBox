...
.. code-block:: python
    ...
    from uvisbox.ProbabilisticSurfaces import probabilistic_marching_cubes_plot
    import matplotlib.pyplot as plt

Define a synthetic scalar field function (e.g., a tear drop shape).

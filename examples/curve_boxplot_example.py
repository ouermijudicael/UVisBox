...
Generate random curves with structured variation and visualize using curve_boxplot:
...
Create figure with 2 subplots and use the curve_boxplot function to visualize
multiple percentile bands and the median curve.
...
.. code-block:: python
    ...
    for curve in curves:
        ax1.plot(curve[:, 0], curve[:, 1], color='lightgray', 

...
ColorTree Colormap Example (VSUP)
---------------------------------

This example demonstrates the use of the ``ColorTree`` colormap for visualizing value and uncertainty, inspired by Value-Suppressing Uncertainty Palettes (VSUP).

VSUP: https://medium.com/@uwdata/value-suppressing-uncertainty-palettes-426130122ce9

The script below creates a 2D image where the x-axis represents value (0 to 1) and the y-axis represents uncertainty (0 to 1). It visualizes the data using three different modes:
